...
// We create the 2nd tile layer that will be the background of our map.
...
// We create the 4th tile layer that will be the background of our map.
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  rawTectonicPlates = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"

  d3.json(rawTectonicPlates).then(function(data) {
    L.geoJson(data, {
      color: "rgba(85, 87, 102, 0.726)",
      weight: 2
